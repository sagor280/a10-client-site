      ...
      <div className="card bg-base-100 w-full mx-auto max-w-sm shrink-0 shadow-2xl border border-gray-200 rounded-3xl">
        <div className="card-body p-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-600 mt-2">Join ImportExport Hub today</p>
          </div>
            ...
            <fieldset className="fieldset space-y-4">
              <div className="form-control">
                ...
                <input
                  ...
                  name="displayName"
                  required
                  className="input input-bordered rounded-full focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
